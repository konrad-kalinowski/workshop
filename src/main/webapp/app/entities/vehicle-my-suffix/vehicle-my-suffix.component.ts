...
export class VehicleMySuffixComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.vehicleService
            ...
            .subscribe(
                (res: HttpResponse<IVehicleMySuffix[]>) => this.paginateVehicles(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/vehicle-my-suffix'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    private paginateVehicles(data: IVehicleMySuffix[], headers: HttpHeaders) {
