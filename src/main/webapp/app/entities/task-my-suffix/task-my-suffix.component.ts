...
export class TaskMySuffixComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.taskService
            ...
            .subscribe(
                (res: HttpResponse<ITaskMySuffix[]>) => this.paginateTasks(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/task-my-suffix'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    private paginateTasks(data: ITaskMySuffix[], headers: HttpHeaders) {
