...
@Component({
    selector: 'jhi-repair-history-my-suffix',
    templateUrl: './repair-history-my-suffix.component.html'
})
export class RepairHistoryMySuffixComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.repairHistoryService
            ...
            .subscribe(
                (res: HttpResponse<IRepairHistoryMySuffix[]>) => this.paginateRepairHistories(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/repair-history-my-suffix'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: IRepairHistoryMySuffix) {
        return item.id;
    }
    ...
    private paginateRepairHistories(data: IRepairHistoryMySuffix[], headers: HttpHeaders) {
