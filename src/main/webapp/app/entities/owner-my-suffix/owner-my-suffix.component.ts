...
export class OwnerMySuffixComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.ownerService
            ...
            .subscribe(
                (res: HttpResponse<IOwnerMySuffix[]>) => this.paginateOwners(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/owner-my-suffix'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: IOwnerMySuffix) {
        return item.id;
    }
    ...
    private paginateOwners(data: IOwnerMySuffix[], headers: HttpHeaders) {
