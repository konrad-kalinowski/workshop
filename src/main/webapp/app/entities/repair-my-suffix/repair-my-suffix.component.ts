...
export class RepairMySuffixComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.repairService
            ...
            .subscribe(
                (res: HttpResponse<IRepairMySuffix[]>) => this.paginateRepairs(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/repair-my-suffix'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: IRepairMySuffix) {
        return item.id;
    }
    ...
    private paginateRepairs(data: IRepairMySuffix[], headers: HttpHeaders) {
