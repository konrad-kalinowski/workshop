...
import { CompanyInfoComponent } from 'app/entities/company-info/company-info.component';
...
describe('Component Tests', () => {
    describe('CompanyInfo Management Component', () => {
        let comp: CompanyInfoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CompanyInfoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.companyInfos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
