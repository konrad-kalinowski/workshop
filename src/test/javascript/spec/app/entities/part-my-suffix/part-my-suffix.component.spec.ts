...
import { PartMySuffixComponent } from 'app/entities/part-my-suffix/part-my-suffix.component';
...
describe('Component Tests', () => {
    describe('PartMySuffix Management Component', () => {
        let comp: PartMySuffixComponent;
        let fixture: ComponentFixture<PartMySuffixComponent>;
        let service: PartMySuffixService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [WorkshopTestModule],
                declarations: [PartMySuffixComponent],
                providers: [
                    {
                ...
                .overrideTemplate(PartMySuffixComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(PartMySuffixComponent);
