...
describe('Service Tests', () => {
    describe('OwnerMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(OwnerMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should create a OwnerMySuffix', () => {
                service.create(new OwnerMySuffix(null)).subscribe(received => {
            ...
            it('should update a OwnerMySuffix', () => {
                service.update(new OwnerMySuffix(123)).subscribe(received => {
            ...
            it('should return a OwnerMySuffix', () => {
            ...
            it('should return a list of OwnerMySuffix', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new OwnerMySuffix(123)]);
            });
