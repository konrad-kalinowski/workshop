...
import { RepairHistoryComponent } from 'app/entities/repair-history/repair-history.component';
...
describe('Component Tests', () => {
    describe('RepairHistory Management Component', () => {
        let comp: RepairHistoryComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(RepairHistoryComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.repairHistories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
